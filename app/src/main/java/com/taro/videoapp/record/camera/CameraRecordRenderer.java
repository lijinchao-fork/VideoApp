...
import com.taro.videoapp.record.gles.FullFrameRect;
import com.taro.videoapp.record.gles.GlUtil;
import com.taro.videoapp.record.video.EncoderConfig;
import com.taro.videoapp.record.video.TextureMovieEncoder;
...
public class CameraRecordRenderer implements GLSurfaceView.Renderer {
    ...
    public CameraRecordRenderer(Context applicationContext, CameraSurfaceView.CameraHandler cameraHandler) {
        ...
        mVideoEncoder = new TextureMovieEncoder(applicationContext);
    }
