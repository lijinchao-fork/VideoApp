package com.taro.videoapp.mediaimage;
...
import com.taro.media.image.ImageEglSurface;
import com.taro.media.image.ImageRenderer;
import com.taro.videoapp.R;


public class MediaImageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public class FilterTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        @Override protected Bitmap doInBackground(Void... params) {
            ...
            final Bitmap bitmap =
                    BitmapFactory.decodeResource(mContext.getResources(), R.drawable.topics01,
                            options);
