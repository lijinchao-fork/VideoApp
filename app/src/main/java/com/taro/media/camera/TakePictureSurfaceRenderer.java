...
import com.taro.media.widget.TakePictureSurfaceView;

import javax.microedition.khronos.egl.EGLConfig;
import javax.microedition.khronos.opengles.GL10;

@TargetApi(11)
public class TakePictureSurfaceRenderer implements GLSurfaceView.Renderer {

    private final Context mContext;
    private final TakePictureSurfaceView.CameraHandler mCameraHandler;
    ...
    public TakePictureSurfaceRenderer(Context context, TakePictureSurfaceView.CameraHandler cameraHandler) {
        mContext = context;
